"""
Django settings for relaxspa project.
...
SECRET_KEY = "django-insecure-_(qgo3((*a57c(h0xawkq^=x-z(a7of5c^4g3p5hr0b2)tzz@&"
...
WSGI_APPLICATION = "relaxspa.wsgi.application"
...
DEFAULT_FROM_EMAIL = 'coffeeshop@mysite.com'
